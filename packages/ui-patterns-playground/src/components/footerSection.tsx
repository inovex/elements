...
import inovexLogo from '../../../landingpage/public/inovex-logo.svg';

function FooterSection() {
  return (
    <footer className="bg-inovex-n-1 rounded-3xl" aria-labelledby="footer">
      ...
      <div className="px-4 py-12 mx-auto max-w-7xl sm:px-6 md:px-16">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div>
            <a className="title-m text-inovex-primary">inovex Elements</a>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-2 label-m space-y-2">
                  <li>
                    <a className="hover:text-inovex-primary" href="#">
                      Info
                    </a>
                  </li>
                  <li>
          ...
          <div className="col-span-3 border-t mt-6 flex flex-wrap  sm:justify-start items-center g ">
            <InoImg height={30} width={30} src={inovexLogo} className="mr-1" />
            <a
              className="label-s"
              target="_blank"
