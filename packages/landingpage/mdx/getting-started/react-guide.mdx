...
import StepIndicator from 'components/getting-started/stepIndicator';
  ...
  <InoNavMenuSection sectionName='Preparation'>
  ...
  ```
    ...
    <InoNavMenuSection sectionName="Properties">
...
| **icon-trailing** | For the icon to be appended  |
  ...
  <InoNavMenuSection sectionName="Finishing Touches">
  ...
  <InoNavMenuSection sectionName="Wrapping Up">
