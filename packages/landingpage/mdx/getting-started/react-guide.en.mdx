...
| inoFocus      | Emits when the input field is focused                                          | CustomEvent\<void>   |
  ...
  Many components of the inovex Elements Library have **slots**, that can be filled by other components or your own content to further customize its functionality or appearance.
