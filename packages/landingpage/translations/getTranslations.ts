...
export const getTranslation = async (locale: SupportedLanguages): Promise<LocaleResource> =>
  dictionaries[locale]?.() ?? dictionaries.en();

export const translator = async (key: LocaleResourcePaths, lang: SupportedLanguages) =>
