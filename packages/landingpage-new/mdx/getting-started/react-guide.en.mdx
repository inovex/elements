...
<div style={{ display: "flex", alignItems: "center", justifyContent: 'space-between' }}>
  ...
  alt="A depiction of the login form to be built"
  style={{
    borderRadius: '12px',
  }}
/>
...
| `showLabelHint` | `show-label-hint` | If true, an _optional_ message is displayed if not required, otherwise a \* marker is displayed if required. | `boolean`                                                                                        | `undefined`  |
| `value`         | `value`           | The value of this input field.                                                                               | `string`                                                                                         | `''`         |
