...
export default function SettingsComponent() {
  ...
  return (
    <InoNavDrawer className="relative" anchor="left" variant="docked" open>
      ...
      <main
        slot="app"
        className="bg-white px-20 py-10 h-screen xl:min-w-[1125px]"
      >
        <InoTabBar onActiveTabChange={handleTabChange} activeTab={activeTabIndex}>
          <InoTab
            label="Account"
            a11y-controls="account-panel"
            data-target="account-panel"
          ></InoTab>
          <InoTab
            label="Notification"
            a11y-controls="notification-panel"
            data-target="notification-panel"
          ></InoTab>
          <InoTab
            label="Updates"
            a11y-controls="update-panel"
            data-target="update-panel"
          ></InoTab>
        </InoTabBar>
        ...
        {activeTabIndex === 0 && (
          <div
            id="account-panel"
            className="panel grid xl:grid-cols-[2fr,1fr] grid-cols-1 xl:gap-20 gap-10 py-10"
          >
            <div>
