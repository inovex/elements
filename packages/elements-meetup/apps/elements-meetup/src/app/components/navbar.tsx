    ...
    <nav className="w-full bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center">
            <Link href="/settings" className="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md !text-gray-500 hover:!text-gray-900 hover:!bg-gray-50">
      ...
      <div className="sm:hidden" id="mobile-menu">
        <div className="pt-2 pb-3 space-y-1">
          ...
          <Link href="/settings" className="block pl-3 pr-4 py-2 text-base font-medium !text-gray-500 hover:!text-gray-900 hover:!bg-gray-50">
