...
const storybookElementsJsonPath = resolve(__dirname, '..', '..', 'storybook', 'elements-stencil-docs.json');

type ComponentProps = keyof JsonDocs['components'][number];

const KEYS_TO_DELETE: ComponentProps[] = ['dirPath', 'readmePath', 'usagesDir'];
