...
| `helper`           | `helper`            | A helper text to display below the select element.                                                                                              | `string`  | `undefined` |
| `helperPersistent` | `helper-persistent` | Displays the helper text permanently.                                                                                                           | `boolean` | `undefined` |
