...
| `helper`                 | `helper`                   | <span style="color:red">**[DEPRECATED]**</span> Use `helperText' instead.  The optional helper text.<br/><br/>                                                                                                                                            | `string`                                                                                         | `undefined` |
| `helperCharacterCounter` | `helper-character-counter` | <span style="color:red">**[DEPRECATED]**</span> Use `showCharacterCounter' instead.  Displays the number of characters. The maxlength-property must be set. This helper text will be displayed persistently.<br/><br/>                                    | `boolean`                                                                                        | `undefined` |
| `helperPersistent`       | `helper-persistent`        | <span style="color:red">**[DEPRECATED]**</span> Use `helperTextPersistent' instead.  Displays the helper permanently.<br/><br/>                                                                                                                           | `boolean`                                                                                        | `undefined` |
...
| `helperValidation`       | `helper-validation`        | <span style="color:red">**[DEPRECATED]**</span> Use `helperTextValidation' instead.  Styles the helper text as a validation message.<br/><br/>                                                                                                            | `boolean`                                                                                        | `undefined` |
...
| `showCharacterCounter`   | `show-character-counter`   | Displays the number of characters. The maxlength-property must be set. This helper text will be displayed persistently.                                                                                                                                   | `boolean`                                                                                        | `undefined` |
