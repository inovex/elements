...
| `colorScheme` | `color-scheme` | Sets the color scheme of the tooltip.  Valid options include: `light`, `dark`, `primary` or `transparent`.                                                                                                                                                               | `"dark" \| "light" \| "primary" \| "transparent"`                                                                                                                                                                                                                                                                                      | `'primary'`          |
