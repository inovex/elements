...
export class Selection implements ComponentInterface {
   ...
   */
  @Event() optionCreated: EventEmitter<string | { key: string; value: string }>;
  ...
  private initComponents = () => {
    this.inoPopoverEl?.removeEventListener(
      'visibleChanged',
      this.initSelection
    );
    ...
    this.inoPopoverEl?.addEventListener(
      'visibleChanged',
  ...
  private createNoMatchMessage(query: string): HTMLDivElement {
    ...
    message.setAttribute(
      'class',
      'ino-selection__list-item ino-selection__list-item--no-match'
    );
        ...
        >
          ...
          <div class="popover-content">
            <header ref={(el) => (this.optionListAnchor = el)}>
              <ino-input placeholder={this.label} outline={true}>
