...
| `dialogRole`         | `dialog-role`           | The role of the dialog. Can be either 'dialog' or 'alertdialog'. The 'alertdialog' role should be used for important messages that requires user interaction. | `"alert" \| "alertdialog"`                       | `'alert'`                                                                   |
