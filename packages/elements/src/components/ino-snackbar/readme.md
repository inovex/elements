...
| -------------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------ | --------------------------------------------------------------------------- |
| `a11yLabels`         | --                      | The aria-labels used for type as well as close icon button.                                                                                                   | `{ snackbarLabel: string; closeLabel: string; }` | `{     snackbarLabel: this.type,     closeLabel: 'Close notification',   }` |
...
| `snackbarRole`       | `snackbar-role`         | The role of the dialog. Can be either 'dialog' or 'alertdialog'. The 'alertdialog' role should be used for important messages that requires user interaction. | `"alert" \| "alertdialog"`                       | `'alert'`                                                                   |
