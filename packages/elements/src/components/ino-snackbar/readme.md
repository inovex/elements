...
| `snackbarRole`       | `snackbar-role`         | The role of the dialog. Can be either 'status', 'alert' or 'alertdialog'. The 'alertdialog' role should be used for important messages that requires user interaction. | `"alert" \| "alertdialog" \| "status"`           | `undefined`                                                                 |
