...
| `inoColorScheme` | `ino-color-scheme` | Color scheme of the snackbar Valid options are: primary, secondary, warning, error                                             | `"error" \| "primary" \| "secondary" \| "warning"` | `undefined` |
