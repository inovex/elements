...
If you would like to add custom icons, you have to add the `.svg` file to the `src/assets/ino-icon` folder and add an entry in the `index.js`, `index.esm.js` and `index.esm.d.ts` files.
