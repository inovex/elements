...
| `helper`               | `helper`                 | <span style="color:red">**[DEPRECATED]**</span> Use `helperText' instead.  The helper text.<br/><br/>                                                                             | `string`                                    | `undefined` |
...
| `helperText`           | `helper-text`            | The helper text.                                                                                                                                                                  | `string`                                    | `undefined` |
