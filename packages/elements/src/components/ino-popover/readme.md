...
| `colorScheme`  | `color-scheme`   | Sets the color scheme of the popup Valid options include: 'primary', 'transparent'                                                                                                                                                                                       | `"dark" \| "light" \| "primary"`                                                                                                                                                                                                                                                                                                       | `'primary'`          |
...
| `headerText`   | `header-text`    | Adds a header test to the `ino-popover`                                                                                                                                                                                                                                  | `string`                                                                                                                                                                                                                                                                                                                               | `undefined`          |
