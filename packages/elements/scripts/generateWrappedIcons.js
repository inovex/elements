...
var DST_ESM = path.join(DST_DIR, 'inovex-elements/icon-assets/SVG/index.esm.js');
var DST_ESM_D_TS = path.join(DST_DIR, 'inovex-elements/icon-assets/SVG/index.esm.d.ts');
