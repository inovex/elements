      ...
      <InoDialog dismissible open={dialogOpen}>
        <div className="ino-dialog-header">
          <div className="ino-dialog-title">
            ...
            <InoIconButton onClickEl={() => setDialogOpen(false)} icon="close" />
          </div>
        </div>
        <div className="ino-dialog-content">
          <InoSelect
            ...
            value={selectedValue}
          >
            <InoOption value="Douglas, Gaylord and Gutmann">Douglas, Gaylord and Gutmann</InoOption>
            <InoOption value="Reinger, Russel and Dooley">Reinger, Russel and Dooley</InoOption>
            <InoOption value="Borer, Barton and Homenick">Borer, Barton and Homenick</InoOption>
            <InoOption value="Gutmann LLC">Gutmann LLC</InoOption>
          </InoSelect>{' '}
        </div>
        <div className="ino-dialog-footer">
          <InoButton onClick={() => setDialogOpen(false)}>Close Dialog</InoButton>
        </div>
      </InoDialog>
    </div>
  );
