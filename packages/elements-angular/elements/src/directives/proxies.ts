...
@ProxyCmp({ inputs: ["autoFocus", "disabled", "form", "inoColorScheme", "inoDense", "inoEdgeMirrored", "inoFill", "inoFullWidth", "inoLoading", "name", "type"] })
@Component({ selector: "ino-button", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["autoFocus", "disabled", "form", "inoColorScheme", "inoDense", "inoEdgeMirrored", "inoFill", "inoFullWidth", "inoLoading", "name", "type"] })
