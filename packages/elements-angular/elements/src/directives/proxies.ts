...
@ProxyCmp({ inputs: ["inoAnimated", "inoAutoplay", "inoHideButtons", "inoInfinite", "inoIntermission", "inoReverse", "value"] })
@Component({ selector: "ino-carousel", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["inoAnimated", "inoAutoplay", "inoHideButtons", "inoInfinite", "inoIntermission", "inoReverse", "value"] })
...
@ProxyCmp({ inputs: ["autoFocus", "disabled", "hourStep", "inoDateFormat", "inoDefaultDate", "inoDefaultHour", "inoDefaultMinute", "inoHelper", "inoHelperPersistent", "inoHelperValidation", "inoLabel", "inoOutline", "inoRange", "inoShowLabelHint", "inoTwelveHourTime", "inoType", "max", "min", "minuteStep", "name", "required", "value"] })
@Component({ selector: "ino-datepicker", changeDetection: ChangeDetectionStrategy.OnPush, template: "<ng-content></ng-content>", inputs: ["autoFocus", "disabled", "hourStep", "inoDateFormat", "inoDefaultDate", "inoDefaultHour", "inoDefaultMinute", "inoHelper", "inoHelperPersistent", "inoHelperValidation", "inoLabel", "inoOutline", "inoRange", "inoShowLabelHint", "inoTwelveHourTime", "inoType", "max", "min", "minuteStep", "name", "required", "value"] })
