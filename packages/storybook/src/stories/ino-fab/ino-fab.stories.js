...
export const DefaultUsage = () => /*html*/ `
  ...
  "top-left"
      ...
      ino-mini="${boolean("ino-mini", false)}">
        <ino-icon slot="ino-icon-leading" ino-icon="${select("ino-leading-icon", ICONS, "add")}"/>
      </ino-fab>

    <h4>Variants</h4>
      <div class="ino-fab-variants">
        <ino-fab ino-tooltip-placement="none" ino-label="Default Fab">
          <ino-icon slot="ino-icon-leading" ino-icon="add"></ino-icon>
        </ino-fab>
        <ino-fab ino-mini ino-label="Mini Fab">
            <ino-icon slot="ino-icon-leading" ino-icon="add"></ino-icon>
        </ino-fab>
        <ino-fab ino-extended ino-label="Extended Button">
            <ino-icon slot="ino-icon-leading" ino-icon="add"></ino-icon>
        </ino-fab>
        <ino-fab ino-disabled ino-label="Disabled Button">
            <ino-icon slot="ino-icon-leading" ino-icon="add"></ino-icon>
        </ino-fab>
      </div>
    </div>
    ...
    <div class="ino-fab-variants">
       <ino-fab ino-label="top-left" ino-edge-position="top-left">
           <ino-icon slot="ino-icon-leading" ino-icon="add"></ino-icon>
       </ino-fab>
       <ino-fab ino-label="top-right" ino-edge-position="top-right">
           <ino-icon slot="ino-icon-leading" ino-icon="add"></ino-icon>
       </ino-fab>
       <ino-fab ino-label="bottom-right" ino-edge-position="bottom-right">
           <ino-icon slot="ino-icon-leading" ino-icon="add"></ino-icon>
       </ino-fab>
       <ino-fab ino-label="bottom-left" ino-edge-position="bottom-left">
           <ino-icon slot="ino-icon-leading" ino-icon="add"></ino-icon>
       </ino-fab>
       <ino-fab ino-label="none" ino-edge-position="none">
           <ino-icon slot="ino-icon-leading" ino-icon="add"></ino-icon>
       </ino-fab>
    </div>
  `;
