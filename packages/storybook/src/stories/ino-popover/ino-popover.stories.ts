...
export const Interactions = () => html`
  ...
  <ino-popover for='popover-non-interactive' trigger='click' color-scheme='transparent'>
    <div class='popover-content'>
      I'm not interactive. I will close on click. I should only be used for non-interactive content like this text.
    </div>
  </ino-popover>
  <ino-popover trigger='click' placement='bottom' for='popover-interactive-target' color-scheme='transparent'
               interactive>
  ...
  <ino-button class='placement-button' id='popover-interactive-target'>Interactive Content</ino-button>
`;
...
export const Trigger = () => html`
  ...
  <ino-popover class="popover-content" placement="right" for="popover-focus" trigger="focus">
...
export const ControlledPopover = () => {
  ...
  return html`
    <ino-popover id="controlled-popover" placement="left" controlled trigger="click">
