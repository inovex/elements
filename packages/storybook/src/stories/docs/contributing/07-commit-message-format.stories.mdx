...
> You can always check which package/scope combinations are allowed by checking the [scopes in the semantic.yml](https://github.com/inovex/elements/blob/master/.github/semantic.yml#L15) file.
