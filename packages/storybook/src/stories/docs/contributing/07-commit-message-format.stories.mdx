...
> You can always check which package/scope combinations are allowed by checking the [scopes in the semantic.yml](https://github.com/inovex/elements/blob/666fd2132f42e91dd0a5b81a37c4d7a0d039a5b5/.github/semantic.yml#L15-L217) file.
