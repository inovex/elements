...
Please follow these steps for integration into Vue.js(3.0.0 or later):
...
Before you start using the inovex Elements icons, you need to prepare the project.
Open `src/main.js` and add the following code snippet on the first lines to use the inovex Elements vue wrapper.
...
## Vue.js 2
Please follow these steps for integration into Vue.js(2.x.x and earlier):
...
> Hint: We do not provide an integration package for Vue.js(2.x.x and earlier) as we do for Angular and React.
