  ...
  <div class="story-nav-drawer__default">
    ...
    >
      ...
      <main slot="app" class="main-content">
        <ino-button fill="outline" dense class="toggle-nav">Toggle Navigation</ino-button>
        <br /> <br />
        Your App goes here 🤘
        ${mainContent}
        <br/><br />
...
export const Dismissible = () => {
  return html`
    <div class="story-nav-drawer__dismissible">
      <ino-nav-drawer variant="dismissible" class="nav-drawer-dismissible" anchor="left">
        ${navContent}
        <main slot="app" class="main-content">
          <ino-button fill="outline" dense class="toggle-nav">Toggle Navigation</ino-button>
          ${mainContent}
