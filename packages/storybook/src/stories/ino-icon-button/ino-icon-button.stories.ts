...
export default {
  title: 'Components (WIP)/ino-icon-button',
  component: 'ino-icon-button',
  decorators: [defaultDecorator],
  parameters: {
    actions: {
      handles: [
        'click ino-icon-button'
      ],
    },
  },
};
...
export const Filled = () => html`
  <div class="flex-parent-center">
    <div class="flex-child">
      <h4>Primary</h4>
      <ino-icon-button icon="time" color-scheme="primary" filled></ino-icon-button>
    </div>
    <div class="flex-child">
      <h4>Secondary</h4>
      <ino-icon-button icon="time" color-scheme="secondary" filled></ino-icon-button>
    </div>
    <div class="flex-child">
      <h4>Success</h4>
      <ino-icon-button icon="time" color-scheme="success" filled></ino-icon-button>
    </div>
    <div class="flex-child">
      <h4>Warning</h4>
      <ino-icon-button icon="time" color-scheme="warning" filled></ino-icon-button>
    </div>
    <div class="flex-child">
      <h4>Error</h4>
      <ino-icon-button icon="time" color-scheme="error" filled></ino-icon-button>
    </div>
  </div>
`;
...
export const States = () => html`
  <div class="flex-parent-center">
    <div class="flex-child">
      ...
      <ino-icon-button class="managed" icon="time" color-scheme="primary" activated></ino-icon-button>
    </div>

    <div class="flex-child">
      <h4>Activated (Managed, Filled)</h4>
      <ino-icon-button class="managed" icon="time" color-scheme="primary" filled activated></ino-icon-button>
    </div>
  </div>
`;
...
export const Variations = () => html`
  <div class="flex-parent-center">
    <div class="flex-child">
      ...
      <ino-icon-button filled color-scheme="primary" icon="time"></ino-icon-button>
    </div>
    <div class="flex-child">
      <h5>CSS Variables</h5>
      <ino-icon-button
