...
export const HelperTexts = () => html`
  ...
  <ino-input required placeholder="Validation message for required input" helper="This field is required" helper-validation></ino-input>
...
export const NumberFormats = () => html`
  ...
  <ino-input thousands-separator placeholder="With thousands separator"></ino-input>
`;

export const Metadata = () => html`
  <ino-input value="2,00" decimal-places="2" thousands-separator unit="€" label="Euro Input"></ino-input>
