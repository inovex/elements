...
export default {
  ...
  decorators: [(story) => decorateStoryWithClass(story, 'story-datepicker')],
  args: {
    attachToBody: true,
    disabled: false,
    dateFormat: 'Y-m-d',
...
export const DateFormats = templateFormats.generateStoryForProp(
  'dateFormat',
  ''
);
...
export const TwelveHourTime = templateTwelveHourTime.generateStoryForProp(
  'twelveHourTime',
  true
);
