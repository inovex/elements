    ...
    (story) => {
      useEffect(() => {
        ...
        const checkedChangeHandler = function (e) {
          ...
          const group: HTMLInoSegmentGroupElement =
            segmentButton.closest('ino-segment-group');
  ...
  (args) => html`
    ...
    >
      ...
      <div class="ino-dialog-footer">
        <ino-button icon="remove" data-ino-dialog-action="cancel" fill="outline"
          >Cancel
        </ino-button>
