...
| `inoExtended`         | `ino-extended`          | Optional, modifies the FAB to wider size which includes a text label.                                                                                                                                             | `boolean` |
| `inoIcon`             | `ino-icon`              | Adds an icon to the Fab.                                                                                                                                                                                          | `string`  |
| `inoLabel`            | `ino-label`             | Optional, for the text label. Applicable only for Extended FAB.                                                                                                                                                   | `string`  |
| `inoMini`             | `ino-mini`              | Optional, modifies the FAB to a smaller size                                                                                                                                                                      | `boolean` |
| `inoTooltipPlacement` | `ino-tooltip-placement` | The placement of the tooltip. Accepted values: `top(-start, -end)`, `right(-start, -end)`, `bottom(-start, -end)`, `left(-start, -end)`                                                                           | `string`  |
