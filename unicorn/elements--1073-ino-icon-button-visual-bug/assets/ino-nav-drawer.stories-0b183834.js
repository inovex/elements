import{x as P}from"./lit-html-b5e645d2.js";import{S as a}from"./StoryWrapper-3e20c0a0.js";import"./elements-stencil-docs-052eb9a9.js";const F=""+new URL("elements-677dc54a.svg",import.meta.url).href;const{useEffect:k}=__STORYBOOK_MODULE_PREVIEW_API__,d=function(e){const o=e.target;o.tagName.toLowerCase()==="ino-nav-drawer"&&o.setAttribute("open",!!e.detail)},i=e=>{e.preventDefault(),e.stopPropagation();const o=e.target.parentElement;if(o.className.includes("toggle-nav")){const t=o.closest("ino-nav-drawer");t.open=!t.open;return}if(o.className.includes("nav-drawer-modal")){o.open=!o.open;return}if(o.tagName.toLowerCase()==="ino-list-item"){const r=o.closest("ino-nav-drawer").querySelectorAll("ino-list-item");r&&r.forEach(N=>{N.activated=!1}),o.activated=!0;return}},M={title:"Structure/ino-nav-drawer",component:"ino-nav-drawer",parameters:{actions:{handles:["openChange .customizable-drawer","click .toggle-nav","clickEl ino-nav-item"]}},decorators:[e=>(k(()=>(document.addEventListener("openChange",d),document.addEventListener("click",i),document.addEventListener("clickEl",i),()=>{document.removeEventListener("openChange",d),document.removeEventListener("click",i),document.removeEventListener("clickEl",i)})),e())],render:e=>{var o,t,r;return P`
