import{x as b}from"./lit-html-b5e645d2.js";import{S as d}from"./StoryWrapper-3e20c0a0.js";import"./elements-stencil-docs-052eb9a9.js";const{useEffect:S}=__STORYBOOK_MODULE_PREVIEW_API__,g={title:"Input/ino-radio",component:"ino-radio",parameters:{actions:{handles:["checkedChange ino-radio"]}},decorators:[e=>(S(()=>{const s=r=>r.target.setAttribute("checked",r.detail),c=document.querySelectorAll("ino-radio");return c.forEach(r=>r.addEventListener("checkedChange",s)),()=>c.forEach(r=>r.removeEventListener("checkedChange",s))}),e())],render:e=>b`
    <ino-radio
      checked="${e.checked}"
      disabled="${e.disabled}"
      name="${e.name}"
