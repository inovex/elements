import{b as S}from"./lit-html-odaN0r1L.js";import{S as a}from"./StoryWrapper-CB660Xf5.js";import"./elements-stencil-docs-CE9fhhj4.js";const r=t=>{const c=t.target.closest("ino-fab-set");c.openDial=!c.openDial},y={title:"Buttons/ino-fab-set",component:"ino-fab-set",parameters:{actions:{handles:["click ino-fab"]},docs:{story:{height:"300px"}}},render:t=>S`
    <ino-fab-set
