import{b as F}from"./lit-html-odaN0r1L.js";import{S as t}from"./StoryWrapper-CB660Xf5.js";import{i as N}from"./elements-zjO0KHcQ.js";import"./elements-stencil-docs-CE9fhhj4.js";const{useEffect:k}=__STORYBOOK_MODULE_PREVIEW_API__,d=function(e){const o=e.target;o.tagName.toLowerCase()==="ino-nav-drawer"&&o.setAttribute("open",!!e.detail)},a=e=>{e.preventDefault(),e.stopPropagation();const o=e.target.parentElement;if(o.className.includes("toggle-nav")){const r=o.closest("ino-nav-drawer");r.open=!r.open;return}if(o.className.includes("nav-drawer-modal")){o.open=!o.open;return}if(o.tagName.toLowerCase()==="ino-list-item"){const l=o.closest("ino-nav-drawer").querySelectorAll("ino-list-item");l&&l.forEach(P=>{P.activated=!1}),o.activated=!0;return}},A={title:"Structure/ino-nav-drawer",component:"ino-nav-drawer",parameters:{actions:{handles:["openChange .customizable-drawer","click .toggle-nav","clickEl ino-nav-item"]}},decorators:[e=>(k(()=>(document.addEventListener("openChange",d),document.addEventListener("click",a),document.addEventListener("clickEl",a),()=>{document.removeEventListener("openChange",d),document.removeEventListener("click",a),document.removeEventListener("clickEl",a)})),e())],render:e=>{var o,r;return F`
    <div class="story-nav-drawer__default">
      <ino-nav-drawer ?open=${e.open} anchor="${e.anchor}" variant="${e.variant}" class="customizable-drawer">
        <div slot="header">
          <ino-img slot="logo" src=${N} width="22" height="31" alt="inovex Elements Logo"></ino-img>
          <p>inovex Elements</p>
        </div>
        <ino-list role="menubar" slot="content" aria-label=${(o=e.a11yLabels)==null?void 0:o.content}>
        ...
        <ino-list role="menubar" slot="footer" aria-label=${(r=e.a11yLabels)==null?void 0:r.footer}>
...
})`,...(w=(y=s.parameters)==null?void 0:y.docs)==null?void 0:w.source}}};var E,S,D;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`Story({
  ...Default,
  docsFromProperty: 'variant',
  args: {
    variant: 'dismissible'
  }
})`,...(D=(S=c.parameters)==null?void 0:S.docs)==null?void 0:D.source}}};var L,_,x;m.parameters={...m.parameters,docs:{...(L=m.parameters)==null?void 0:L.docs,source:{originalSource:`Story({
  ...Default,
  docsFromProperty: 'variant',
  args: {
    variant: 'mobile',
...
})`,...(x=(_=m.parameters)==null?void 0:_.docs)==null?void 0:x.source}}};const O=["Default","AnchorRight","Modal","Dismissible","Mobile"];export{i as AnchorRight,n as Default,c as Dismissible,m as Mobile,s as Modal,O as __namedExportsOrder,A as default};
