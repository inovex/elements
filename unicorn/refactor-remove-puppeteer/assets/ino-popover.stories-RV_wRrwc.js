import{b as i}from"./lit-html-odaN0r1L.js";import{S as r}from"./StoryWrapper-CB660Xf5.js";import"./elements-stencil-docs-CE9fhhj4.js";let oe=1;const re={title:"Notification/ino-popover",component:"ino-popover",parameters:{actions:{handles:["visibleChange ino-popover"]},docs:{story:{height:"200px"}}},argTypes:{placement:{control:{type:"select"},options:["top","right","bottom","left"]},trigger:{control:{type:"select"},options:["mouseenter","focus","click","mouseenter focus","mouseenter click","focus click","mouseenter focus click"]},colorScheme:{control:{type:"select"},options:["light","dark","primary"]},delay:{control:{type:"object"}},followCursor:{control:{type:"radio"},options:[!0,!1,"initial","horizontal","vertical"]}},render:e=>{const t=`popover-${oe++}`;return i`
    ...
    `},args:{controlled:!1,distance:15,for:"popover-target",interactive:!1,placement:"top",trigger:"mouseenter",colorScheme:"light",visible:!1,hideOnEsc:!1,hideOnBlur:!1,delay:0,arrow:!1,placementClass:"",headerText:""}},o=r({...re}),c=r({...o,docsFromProperty:"arrow",args:{arrow:!0}}),a=r({...o,docsFromProperty:"placement",args:{placement:"right",placementClass:"styled-placement"}}),s=r({...o,docsFromProperty:"attachToBody",args:{attachToBody:!0}}),l=r({...o,docsFromProperty:"distance",args:{distance:30}}),d=r({...o,docsFromProperty:"colorScheme",render:e=>{const t="popover-light",n="popover-dark",$="popover-primary",y=i`<p style="padding: 0.5rem">
      ...
      <ino-button id="${n}">Dark</ino-button>
      <ino-popover
        color-scheme="dark"
        controlled="${e.controlled}"
        distance="${e.distance}"
  ...
  `,args:{interactive:!0}}),v=r({...o,docsFromProperty:"controlled",render:()=>i`
      <ino-popover
        ...
        visible="false"
        distance="15"
        @visibleChanged="${t=>{var n;(n=t.target)==null||n.setAttribute("visible",t.detail),document.querySelector("#controlled-checkbox").checked=t.detail}}"
      >
...
})`,...(D=(F=a.parameters)==null?void 0:F.docs)==null?void 0:D.source}}};var O,B,x;s.parameters={...s.parameters,docs:{...(O=s.parameters)==null?void 0:O.docs,source:{originalSource:`Story({
  ...Default,
  docsFromProperty: 'attachToBody',
  args: {
    attachToBody: true
  }
})`,...(x=(B=s.parameters)==null?void 0:B.docs)==null?void 0:x.source}}};var E,T,L;l.parameters={...l.parameters,docs:{...(E=l.parameters)==null?void 0:E.docs,source:{originalSource:`Story({
  ...Default,
