import{b as t}from"./lit-html-odaN0r1L.js";import{S as a}from"./StoryWrapper-CB660Xf5.js";import"./elements-stencil-docs-CE9fhhj4.js";const D=t`<ino-icon icon="onboarding"></ino-icon>`,n={title:"Structure/ino-nav-item",component:"ino-nav-item",render:e=>t`
    <ino-list>
      <ino-nav-item
  ...
  `,args:{text:"Some Text",disabled:!0}}),o=a({...n});var d,l,x;s.parameters={...s.parameters,docs:{...(d=s.parameters)==null?void 0:d.docs,source:{originalSource:`Story({
  ...InoNavItemMeta
