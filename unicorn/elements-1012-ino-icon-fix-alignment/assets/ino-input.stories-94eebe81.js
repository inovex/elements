import{x as i}from"./lit-html-b5e645d2.js";import{S as t}from"./StoryWrapper-b39d0c39.js";import"./elements-stencil-docs-a0365730.js";const{useEffect:ie}=__STORYBOOK_MODULE_PREVIEW_API__,te={title:"Input/ino-input",component:"ino-input",decorators:[e=>(ie(()=>{const h=o=>o.target.setAttribute("value",o.detail),m=document.querySelectorAll("ino-input");return m.forEach(o=>o.addEventListener("valueChange",h)),()=>m.forEach(o=>o.removeEventListener("valueChange",h))}),e())],render:e=>i`
    <ino-input
