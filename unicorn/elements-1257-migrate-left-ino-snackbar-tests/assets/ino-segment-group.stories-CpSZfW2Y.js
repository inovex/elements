import{x as s}from"./lit-html-D-ZEPr28.js";import{S as p}from"./StoryWrapper-8ope1Itq.js";import"./elements-stencil-docs-A79BTi6O.js";const u=({detail:e,target:r})=>r.value=e,m={title:"Buttons/ino-segment-group",component:"ino-segment-group",parameters:{actions:{handles:["checkedChange"]}},render:e=>s`
    <ino-segment-group
      id="segment-grp"
      name="${e.name}"
      value="${e.value}"
