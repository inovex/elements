import{x as k}from"./lit-html-D-ZEPr28.js";import{S as r}from"./StoryWrapper-8ope1Itq.js";import"./elements-stencil-docs-A79BTi6O.js";const q={title:"Buttons/ino-button",component:"ino-button",parameters:{docs:{source:{format:"html"}}},render:n=>k`
    <ino-button
      variant="${n.variant}"
      disabled="${n.disabled}"
      dense="${n.dense}"
