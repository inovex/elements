import{x as k}from"./lit-html-b5e645d2.js";import{S as r}from"./StoryWrapper-2689c8f0.js";import"./elements-stencil-docs-934b8e27.js";const q={title:"Buttons/ino-button",component:"ino-button",parameters:{docs:{source:{format:"html"}}},render:n=>k`
    <ino-button
      variant="${n.variant}"
      disabled="${n.disabled}"
      dense="${n.dense}"
