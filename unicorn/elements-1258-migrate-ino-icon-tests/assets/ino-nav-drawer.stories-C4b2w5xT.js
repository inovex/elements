import{x as F}from"./lit-html-D-ZEPr28.js";import{S as t}from"./StoryWrapper-8ope1Itq.js";import{i as N}from"./elements-zjO0KHcQ.js";import"./elements-stencil-docs-A79BTi6O.js";const{useEffect:k}=__STORYBOOK_MODULE_PREVIEW_API__,d=function(e){const o=e.target;o.tagName.toLowerCase()==="ino-nav-drawer"&&o.setAttribute("open",!!e.detail)},a=e=>{e.preventDefault(),e.stopPropagation();const o=e.target.parentElement;if(o.className.includes("toggle-nav")){const r=o.closest("ino-nav-drawer");r.open=!r.open;return}if(o.className.includes("nav-drawer-modal")){o.open=!o.open;return}if(o.tagName.toLowerCase()==="ino-list-item"){const l=o.closest("ino-nav-drawer").querySelectorAll("ino-list-item");l&&l.forEach(P=>{P.activated=!1}),o.activated=!0;return}},A={title:"Structure/ino-nav-drawer",component:"ino-nav-drawer",parameters:{actions:{handles:["openChange .customizable-drawer","click .toggle-nav","clickEl ino-nav-item"]}},decorators:[e=>(k(()=>(document.addEventListener("openChange",d),document.addEventListener("click",a),document.addEventListener("clickEl",a),()=>{document.removeEventListener("openChange",d),document.removeEventListener("click",a),document.removeEventListener("clickEl",a)})),e())],render:e=>{var o,r;return F`
