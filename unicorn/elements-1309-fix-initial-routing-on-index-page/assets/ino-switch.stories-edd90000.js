import{x as f}from"./lit-html-b5e645d2.js";import{S as c}from"./StoryWrapper-03bb9100.js";import"./elements-stencil-docs-98c6df11.js";const $=e=>e.target.checked=e.detail,y={title:"Input/ino-switch",component:"ino-switch",render:e=>f`
    <ino-switch
      checked="${e.checked}"
      disabled="${e.disabled}"
      name="${e.name}"
