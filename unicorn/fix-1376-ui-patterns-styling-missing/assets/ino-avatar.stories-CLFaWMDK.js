import{x as m}from"./lit-html-D-ZEPr28.js";import{S as e}from"./StoryWrapper-8ope1Itq.js";import"./elements-stencil-docs-A79BTi6O.js";const Y=""+new URL("avatar-jiecYxVn.jpg",import.meta.url).href,{useEffect:B}=__STORYBOOK_MODULE_PREVIEW_API__,G={title:"Graphic/ino-avatar",component:"ino-avatar",decorators:[a=>(B(()=>{const p=n=>{const t=n.target,u=t.closest("div"),w=u==null?void 0:u.querySelector("ino-avatar");t.checked=n.detail,w.setAttribute("loading",t.checked),t.indeterminate&&(t.indeterminate=!1)},g=document.querySelectorAll("ino-checkbox");return g.forEach(n=>n.addEventListener("checkedChange",p)),()=>g.forEach(n=>n.removeEventListener("checkedChange",p))}),a())],render:a=>m`
    <ino-avatar
      initials="${a.initials}"
  ...
  `}),o=e({...r,args:{initials:"JD",interactive:!1,variant:"solid",src:Y},render:a=>m`
    <ino-avatar
      initials="${a.initials}"
      interactive="${a.interactive}"
      variant="${a.variant}"
