import{x as P}from"./lit-html-b5e645d2.js";import{S as t}from"./StoryWrapper-2a1c4c75.js";import"./elements-stencil-docs-5bebb05c.js";const S={title:"Notification/ino-progress-bar",component:"ino-progress-bar",argTypes:{buffer:{control:{min:0,max:1,step:.1}},progress:{control:{min:0,max:1,step:.1}}},render:a=>P`
    <ino-progress-bar
      buffer="${a.buffer}"
      progress="${a.progress}"
