import{x as P}from"./lit-html-f27292d4.js";import{S as t}from"./StoryWrapper-c5407b69.js";import"./elements-stencil-docs-6a7eba8c.js";const S={title:"Notification/ino-progress-bar",component:"ino-progress-bar",argTypes:{buffer:{control:{min:0,max:1,step:.1}},progress:{control:{min:0,max:1,step:.1}}},render:a=>P`
    <ino-progress-bar
      buffer="${a.buffer}"
      progress="${a.progress}"
