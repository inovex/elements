import{x as t}from"./lit-html-f27292d4.js";import{S as a}from"./StoryWrapper-8a412985.js";import"./elements-stencil-docs-1854c044.js";const x={title:"Buttons/ino-fab",component:"ino-fab",render:o=>t`
    <ino-fab
  ...
  \`
})`,...(u=(g=e.parameters)==null?void 0:g.docs)==null?void 0:u.source},description:{story:"In order to achive edges on the fab-button, add `edge-position`.\n\nPossible values are:\n\n- `top-right`\n- `top-left`\n- `bottom-right`\n- `bottom-left`\n- `none` = `top-left`",...(v=(h=e.parameters)==null?void 0:h.docs)==null?void 0:v.description}}};const P=["Default","Variants","EdgePositions"];export{n as Default,e as EdgePositions,i as Variants,P as __namedExportsOrder,x as default};
