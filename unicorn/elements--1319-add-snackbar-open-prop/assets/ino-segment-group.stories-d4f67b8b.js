import{x as s}from"./lit-html-f27292d4.js";import{S as p}from"./StoryWrapper-8a412985.js";import"./elements-stencil-docs-1854c044.js";const u=({detail:e,target:r})=>r.value=e,m={title:"Buttons/ino-segment-group",component:"ino-segment-group",parameters:{actions:{handles:["checkedChange"]}},render:e=>s`
    <ino-segment-group
      id="segment-grp"
      name="${e.name}"
      value="${e.value}"
