import{x as k}from"./lit-html-f27292d4.js";import{S as r}from"./StoryWrapper-8a412985.js";import"./elements-stencil-docs-1854c044.js";const q={title:"Buttons/ino-button",component:"ino-button",parameters:{docs:{source:{format:"html"}}},render:n=>k`
    <ino-button
      variant="${n.variant}"
      disabled="${n.disabled}"
      dense="${n.dense}"
