import{x as k}from"./lit-html-b5e645d2.js";import{S as r}from"./StoryWrapper-c6cdb4db.js";import"./elements-stencil-docs-02981b6f.js";const q={title:"Buttons/ino-button",component:"ino-button",parameters:{docs:{source:{format:"html"}}},render:n=>k`
    <ino-button
      variant="${n.variant}"
      disabled="${n.disabled}"
      dense="${n.dense}"
