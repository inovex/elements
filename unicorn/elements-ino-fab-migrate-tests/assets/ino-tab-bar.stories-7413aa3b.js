import{x as p}from"./lit-html-b5e645d2.js";import{S as d}from"./StoryWrapper-c6cdb4db.js";import"./elements-stencil-docs-02981b6f.js";const{useEffect:m}=__STORYBOOK_MODULE_PREVIEW_API__,n=a=>a.target.setAttribute("active-tab",a.detail),v={title:"Structure/ino-tab-bar",component:"ino-tab-bar",decorators:[a=>(m(()=>{const r=document.querySelectorAll("ino-tab-bar");return r.forEach(o=>o.addEventListener("activeTabChange",n)),()=>r.forEach(o=>o.removeEventListener("activeTabChange",n))}),a())],render:a=>p`
    <ino-tab-bar
