import{x as S}from"./lit-html-b5e645d2.js";import{S as a}from"./StoryWrapper-0e6ce08e.js";import"./elements-stencil-docs-c1412bd4.js";const r=t=>{const c=t.target.closest("ino-fab-set");c.openDial=!c.openDial},F={title:"Buttons/ino-fab-set",component:"ino-fab-set",parameters:{actions:{handles:["click ino-fab"]},docs:{story:{height:"300px"}}},render:t=>S`
    <ino-fab-set
