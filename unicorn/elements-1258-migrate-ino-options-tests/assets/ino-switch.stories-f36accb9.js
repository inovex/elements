import{x as f}from"./lit-html-f27292d4.js";import{S as c}from"./StoryWrapper-c5407b69.js";import"./elements-stencil-docs-6a7eba8c.js";const $=e=>e.target.checked=e.detail,y={title:"Input/ino-switch",component:"ino-switch",render:e=>f`
    <ino-switch
      checked="${e.checked}"
      disabled="${e.disabled}"
      name="${e.name}"
