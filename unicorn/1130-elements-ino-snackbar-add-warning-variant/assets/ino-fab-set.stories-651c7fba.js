import{x as S}from"./lit-html-b5e645d2.js";import{S as a}from"./StoryWrapper-a88f6b4e.js";import"./elements-stencil-docs-7e3df8c7.js";const r=t=>{const c=t.target.closest("ino-fab-set");c.openDial=!c.openDial},F={title:"Buttons/ino-fab-set",component:"ino-fab-set",parameters:{actions:{handles:["click ino-fab"]},docs:{story:{height:"300px"}}},render:t=>S`
    <ino-fab-set
...
})`,...(h=(L=e.parameters)==null?void 0:L.docs)==null?void 0:h.source}}};const $=["Default","DialDirection","LeftRightLocation","TopBottomLocation"];export{o as Default,i as DialDirection,n as LeftRightLocation,e as TopBottomLocation,$ as __namedExportsOrder,F as default};
