import{x as k}from"./lit-html-b5e645d2.js";import{S as r}from"./StoryWrapper-3f0c1834.js";import"./elements-stencil-docs-997710dd.js";const q={title:"Buttons/ino-button",component:"ino-button",parameters:{docs:{source:{format:"html"}}},render:n=>k`
    <ino-button
      variant="${n.variant}"
      disabled="${n.disabled}"
      dense="${n.dense}"
