import{x as s}from"./lit-html-b5e645d2.js";import{S as p}from"./StoryWrapper-91a22e61.js";import"./elements-stencil-docs-7538891b.js";const u=({detail:e,target:r})=>r.value=e,m={title:"Buttons/ino-segment-group",component:"ino-segment-group",parameters:{actions:{handles:["checkedChange"]}},render:e=>s`
    <ino-segment-group
      id="segment-grp"
      name="${e.name}"
      value="${e.value}"
