import{x as F}from"./lit-html-b5e645d2.js";import{S as o}from"./StoryWrapper-91a22e61.js";import"./elements-stencil-docs-7538891b.js";const{useState:I}=__STORYBOOK_MODULE_PREVIEW_API__,$={title:"Input/ino-checkbox",component:"ino-checkbox",render:r=>{const[P,C]=I(r.checked);function D(_){C(_.detail)}return F`
      <ino-checkbox
        checked="${P}"
        disabled="${r.disabled}"
