import{x as f}from"./lit-html-D-ZEPr28.js";import{S as c}from"./StoryWrapper-CFmJx4Rl.js";import"./elements-stencil-docs-CAm1M8Bn.js";const $=e=>e.target.checked=e.detail,y={title:"Input/ino-switch",component:"ino-switch",render:e=>f`
    <ino-switch
      checked="${e.checked}"
      disabled="${e.disabled}"
      name="${e.name}"
