import"./lit-element-VmCeRzaJ.js";import{T as k,w as R,x as h}from"./lit-html-D-ZEPr28.js";import{S as c}from"./StoryWrapper-YhkqXCd1.js";import"./elements-stencil-docs-BCLlNifF.js";/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class u extends W{constructor(e){if(super(e),this.it=k,e.type!==U.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===k||e==null)return this._t=void 0,this.it=e;if(e===R)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}u.directiveName="unsafeHTML",u.resultType=1;const V=q(u),{useEffect:P}=__STORYBOOK_MODULE_PREVIEW_API__,Y=h`<tr slot="header-row"></tr>
