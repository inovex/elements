import{x as i}from"./lit-html-D-ZEPr28.js";import{S as t}from"./StoryWrapper-YhkqXCd1.js";import"./elements-stencil-docs-BCLlNifF.js";const{useEffect:ie}=__STORYBOOK_MODULE_PREVIEW_API__,te={title:"Input/ino-input",component:"ino-input",decorators:[e=>(ie(()=>{const h=o=>o.target.setAttribute("value",o.detail),m=document.querySelectorAll("ino-input");return m.forEach(o=>o.addEventListener("valueChange",h)),()=>m.forEach(o=>o.removeEventListener("valueChange",h))}),e())],render:e=>i`
    <ino-input
  ...
  `}),d=t({...n,docsFromProperty:"unit",render:()=>i` <ino-input value="2" type="number" unit="h" label="Hours input"></ino-input> `});var b,y,g;n.parameters={...n.parameters,docs:{...(b=n.parameters)==null?void 0:b.docs,source:{originalSource:`Story({
  ...InoInputMeta
  ...
  render: () => html\`
    ...
    <ino-input type="password" placeholder="type = password"></ino-input>
  \`
})`,...(x=(v=a.parameters)==null?void 0:v.docs)==null?void 0:x.source},description:{story:"Changes the type of the ino-input element.\n\n- `type`: The type of this element (default = text).\n- `step`: The step value of this element. Use `any` for decimal numbers",...(w=(S=a.parameters)==null?void 0:S.docs)==null?void 0:w.description}}};var D,$,q,T,L;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`Story({
  ...Default,
  render: () => html\`
    <ino-input placeholder="Disabled" disabled></ino-input>
    <ino-input label="Optional" show-label-hint></ino-input>
    ...
    <ino-input label="Outline required" outline show-label-hint required></ino-input>
  \`
})`,...(q=($=l.parameters)==null?void 0:$.docs)==null?void 0:q.source},description:{story:"Change the state of the ino-input element by adding this properties in various combinations:\n\n- `disabled`: Disables this element.\n- `show-label-hint`: If true, an *optional* message is displayed if not required, otherwise a * marker is displayed if required\n- `required`: Marks this element as required.\n- `outline`: Styles the input field as outlined element.",...(L=(T=l.parameters)==null?void 0:T.docs)==null?void 0:L.description}}};var O,H,P,F,I;r.parameters={...r.parameters,docs:{...(O=r.parameters)==null?void 0:O.docs,source:{originalSource:`Story({
  ...Default,
  render: () => html\`
    <ino-input label="Floating label"></ino-input>
    <ino-input label="Floating label" value="With value"></ino-input>
