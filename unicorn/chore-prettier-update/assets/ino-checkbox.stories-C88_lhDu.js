import{x as F}from"./lit-html-D-ZEPr28.js";import{S as o}from"./StoryWrapper-YhkqXCd1.js";import"./elements-stencil-docs-BCLlNifF.js";const{useState:I}=__STORYBOOK_MODULE_PREVIEW_API__,$={title:"Input/ino-checkbox",component:"ino-checkbox",render:r=>{const[P,D]=I(r.checked);function _(C){D(C.detail)}return F`
      <ino-checkbox
        checked="${P}"
        disabled="${r.disabled}"
