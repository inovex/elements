import{x as V}from"./lit-html-b5e645d2.js";import{S as o}from"./StoryWrapper-2a1c4c75.js";import"./elements-stencil-docs-5bebb05c.js";const{useEffect:W}=__STORYBOOK_MODULE_PREVIEW_API__,Y={title:"Input/ino-input-file",component:"ino-input-file",decorators:[e=>(W(()=>{const g=function(i){if(i.stopImmediatePropagation(),i.target.tagName.toLowerCase()!=="ino-input-file")return;const U=i.detail.files.map(m=>[m.name,m.type,m.size+" bytes"].join(", ")).join(`
