import{x as E}from"./lit-html-b5e645d2.js";import{S as s}from"./StoryWrapper-f0285007.js";import"./elements-stencil-docs-936e56f6.js";const{useEffect:S}=__STORYBOOK_MODULE_PREVIEW_API__,y={title:"Structure/ino-card",component:"ino-card",decorators:[o=>(S(()=>{const n=function(f){var c;const a=(c=f.target)==null?void 0:c.closest("ino-card");a&&(a.selected=!a.selected)};return document.addEventListener("click",n),()=>{document.removeEventListener("click",n)}}),o())],render:o=>E`
    <ino-card
