import{x as U}from"./lit-html-b5e645d2.js";import{S as t}from"./StoryWrapper-f0285007.js";import"./elements-stencil-docs-936e56f6.js";const{useEffect:V}=__STORYBOOK_MODULE_PREVIEW_API__,W={title:"Structure/ino-control-item",component:"ino-control-item",decorators:[e=>(V(()=>{const p=u=>{const l=u.target;l.checked=u.detail,l.indeterminate&&(l.indeterminate=!1)};return document.addEventListener("checkedChange",p),()=>document.removeEventListener("checkedChange",p)}),e())],render:e=>U`
