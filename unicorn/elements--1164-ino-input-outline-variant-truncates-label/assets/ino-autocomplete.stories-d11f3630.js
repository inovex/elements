import{x as l}from"./lit-html-b5e645d2.js";import{S as p}from"./StoryWrapper-674d0325.js";import"./elements-stencil-docs-09c5939d.js";const i=e=>{e.target.value=e.detail},m={title:"Input/ino-autocomplete",component:"ino-autocomplete",parameters:{actions:{handles:["valueChange"]}},render:e=>l` <div style="height: 300px;">
    <ino-autocomplete
      debounce="${e.debounce}"
      .options=${e.options}
      value="${e.value}"
