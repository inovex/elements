import{x as S}from"./lit-html-D-ZEPr28.js";import{S as a}from"./StoryWrapper-8ope1Itq.js";import"./elements-stencil-docs-A79BTi6O.js";const r=t=>{const c=t.target.closest("ino-fab-set");c.openDial=!c.openDial},y={title:"Buttons/ino-fab-set",component:"ino-fab-set",parameters:{actions:{handles:["click ino-fab"]},docs:{story:{height:"300px"}}},render:t=>S`
    <ino-fab-set
