import{x as s}from"./lit-html-b5e645d2.js";import{S as p}from"./StoryWrapper-196bd329.js";import"./elements-stencil-docs-8a4f0020.js";const u=({detail:e,target:r})=>r.value=e,m={title:"Buttons/ino-segment-group",component:"ino-segment-group",parameters:{actions:{handles:["checkedChange"]}},render:e=>s`
    <ino-segment-group
      id="segment-grp"
      name="${e.name}"
      value="${e.value}"
