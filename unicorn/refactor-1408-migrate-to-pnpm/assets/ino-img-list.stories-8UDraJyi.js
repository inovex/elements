import{b as e}from"./lit-html-odaN0r1L.js";import{S as s}from"./StoryWrapper-pH0BiVjf.js";import"./elements-stencil-docs-CC_eBxG8.js";const f=""+new URL("beach-YqHz73Lv.jpg",import.meta.url).href,u=""+new URL("fjord-DNr1VnIH.jpg",import.meta.url).href,I=""+new URL("forrest-D2qe1wNf.jpg",import.meta.url).href,y=""+new URL("liberty-Cl7I6P7Q.jpg",import.meta.url).href,$=""+new URL("trondheim-vpxkaSmD.jpg",import.meta.url).href,h=""+new URL("waterfall-Dde7Kyju.jpg",import.meta.url).href,a={title:"Graphic/ino-img-list",component:"ino-img-list",render:m=>e`
    <ino-img-list enclose-label="${m.encloseLabel}" masonry="${m.masonry}">
      ${j} ${w} ${S} ${D} ${M} ${R}
    </ino-img-list>
  `,args:{encloseLabel:!1,masonry:!1}},r=s({...a}),o=s({...a,docsFromProperty:"masonry",args:{masonry:!0}}),t=s({...a,docsFromProperty:"encloseLabel",args:{encloseLabel:!0}}),j=e` <ino-img src=${f} alt="beach" label="Label" img-list-item></ino-img> `,w=e` <ino-img src=${u} alt="fjord" label="Label" img-list-item></ino-img> `,S=e` <ino-img src=${I} alt="forrest" label="Label" img-list-item></ino-img> `,D=e` <ino-img src=${y} alt="liberty" label="Label" img-list-item></ino-img> `,M=e` <ino-img src=${$} alt="trondheim" label="Label" img-list-item></ino-img> `,R=e` <ino-img src=${h} alt="waterfall" label="Label" img-list-item></ino-img> `;var n,l,i;r.parameters={...r.parameters,docs:{...(n=r.parameters)==null?void 0:n.docs,source:{originalSource:`Story({
  ...InoImgListMeta
...
})`,...(d=(L=t.parameters)==null?void 0:L.docs)==null?void 0:d.source}}};const x=["Default","Masonry","EncloseLabel"];export{r as Default,t as EncloseLabel,o as Masonry,x as __namedExportsOrder,a as default};
