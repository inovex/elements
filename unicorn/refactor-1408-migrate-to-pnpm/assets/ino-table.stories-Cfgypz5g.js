import"./lit-element-BwWyWpv3.js";import{A as k,E as q,b as h}from"./lit-html-odaN0r1L.js";import{S as c}from"./StoryWrapper-pH0BiVjf.js";import"./elements-stencil-docs-CC_eBxG8.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const R={CHILD:2},U=d=>(...e)=>({_$litDirective$:d,values:e});class W{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,o){this._$Ct=e,this._$AM=t,this._$Ci=o}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class u extends W{constructor(e){if(super(e),this.it=k,e.type!==R.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===k||e==null)return this._t=void 0,this.it=e;if(e===q)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}u.directiveName="unsafeHTML",u.resultType=1;const J=U(u),{useEffect:N}=__STORYBOOK_MODULE_PREVIEW_API__,K=h`<tr slot="header-row"></tr>
  ...
  <tr>
    ...
    <td>Some information</td>
    <td>Some information</td>
  </tr> `,V={title:"Structure/ino-table",component:"ino-table",inline:!0,decorators:[d=>(N(()=>{const e=document.querySelectorAll("ino-table"),t=o=>{const{columnId:a,sortDirection:n}=o.detail;o.target.sortColumnId=a,o.target.sortDirection=n};return e.forEach(o=>o.addEventListener("sortChange",t)),()=>e.forEach(o=>o.removeEventListener("sortChange",t))}),d())],render:d=>h`
    <ino-table
      loading="${d.loading}"
...
})`,...(H=(p=b.parameters)==null?void 0:p.docs)==null?void 0:H.source}}};var y,S,v;m.parameters={...m.parameters,docs:{...(y=m.parameters)==null?void 0:y.docs,source:{originalSource:`Story({
  ...Default,
  docsFromProperty: 'noHover',
  args: {
    noHover: true
  }
})`,...(v=(S=m.parameters)==null?void 0:S.docs)==null?void 0:v.source}}};var E,D,I,B,$;i.parameters={...i.parameters,docs:{...(E=i.parameters)==null?void 0:E.docs,source:{originalSource:`Story({
  ...Default
})`,...(I=(D=i.parameters)==null?void 0:D.docs)==null?void 0:I.source},description:{story:"For table sorting there are two needed props:\n\n`sortColumnId` identifies the column currently sorted by.\nNeeds to match the column ids provided on `ino-table-header-cell` elements.\n\n`sortDirection` shows direction of the column currently sorted by.\n@See Set `sort-start` attribute on the respective column to change the sort order.\n\nSorting-logic needs to be implemented by user.",...($=(B=i.parameters)==null?void 0:B.docs)==null?void 0:$.description}}};var L,w,A;C.parameters={...C.parameters,docs:{...(L=C.parameters)==null?void 0:L.docs,source:{originalSource:`Story({
  ...Default,
  docsFromProperty: 'stickyHeader',
  args: {
    stickyHeader: true
  }
})`,...(A=(w=C.parameters)==null?void 0:w.docs)==null?void 0:A.source}}};var F,T,G,M,P;s.parameters={...s.parameters,docs:{...(F=s.parameters)==null?void 0:F.docs,source:{originalSource:`Story({
  ...Default,
  render: () => {
...
})`,...(G=(T=s.parameters)==null?void 0:T.docs)==null?void 0:G.source},description:{story:"Use `ino-checkbox` elements in the first column for checkbox-selection",...(P=(M=s.parameters)==null?void 0:M.docs)==null?void 0:P.description}}};const X=["Default","Loading","NoHover","SortColumnIdAndSortDirection","StickyHeader","SelectionWithCheckboxes"];export{l as Default,b as Loading,m as NoHover,s as SelectionWithCheckboxes,i as SortColumnIdAndSortDirection,C as StickyHeader,X as __namedExportsOrder,V as default};
