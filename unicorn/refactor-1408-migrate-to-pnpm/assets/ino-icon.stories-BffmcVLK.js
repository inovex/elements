import{b as s}from"./lit-html-odaN0r1L.js";import{g as f,I as g}from"./utils-ebStcoTl.js";import{S as v}from"./StoryWrapper-pH0BiVjf.js";import"./elements-stencil-docs-CC_eBxG8.js";const{useEffect:b}=__STORYBOOK_MODULE_PREVIEW_API__,I=g.filter(o=>!o.startsWith("_")).concat(["status_zukuenftige","status_abwesend","status_offboarding_laufend"]);function _(o){const n=document.createElement("ino-snackbar");navigator.clipboard.writeText(o).then(()=>{n.innerText=`Successfully copied "${o}" to your clipboard!`}).catch(()=>{n.innerText="An error occurred while copying the id to your clipboard!"}).finally(()=>{document.body.appendChild(n)})}const C=I.sort().filter(o=>o.length>=1),S=C.map(o=>s`
    <ino-chip id="icon-${o}" value="${o}" @chipClicked="${n=>_(n.detail)}">
  ...
  `,argTypes:{icon:{control:{type:"select"},options:f()}},args:{clickable:!0,colorSecondary:!1,icon:"info",svgTitle:"svg-Title",src:"scr-url"}},e=v({...T}),c=v({...e,render:()=>s`
  ...
  \`
})`,...(m=(h=c.parameters)==null?void 0:h.docs)==null?void 0:m.source}}};const x=["Default","AllIcons"];export{c as AllIcons,e as Default,x as __namedExportsOrder,T as default};
