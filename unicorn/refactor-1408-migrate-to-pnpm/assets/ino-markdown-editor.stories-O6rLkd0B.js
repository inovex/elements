import{b as m}from"./lit-html-odaN0r1L.js";import{S as c}from"./StoryWrapper-pH0BiVjf.js";import"./elements-stencil-docs-CC_eBxG8.js";const{useEffect:u}=__STORYBOOK_MODULE_PREVIEW_API__,r="editor-playground",l={title:"Input/ino-markdown-editor",component:"ino-markdown-editor",parameters:{actions:{handles:[]}},decorators:[e=>(u(()=>{const t=i=>{const s=document.getElementById(r);s.viewMode=i.detail};return document.addEventListener("viewModeChange",t),()=>{document.removeEventListener("viewModeChange",t)}}),e())],render:e=>m`
    <ino-markdown-editor
      id="${r}"
