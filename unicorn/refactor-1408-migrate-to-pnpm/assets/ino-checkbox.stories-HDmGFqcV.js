import{b as F}from"./lit-html-odaN0r1L.js";import{S as o}from"./StoryWrapper-CB660Xf5.js";import"./elements-stencil-docs-CE9fhhj4.js";const{useState:I}=__STORYBOOK_MODULE_PREVIEW_API__,$={title:"Input/ino-checkbox",component:"ino-checkbox",render:r=>{const[x,D]=I(r.checked);function _(C){D(C.detail)}return F`
      <ino-checkbox
        checked="${x}"
        disabled="${r.disabled}"
