import{b as r}from"./lit-html-odaN0r1L.js";import{S as o}from"./StoryWrapper-pH0BiVjf.js";import"./elements-stencil-docs-CC_eBxG8.js";const j={title:"Buttons/ino-chip",component:"ino-chip",parameters:{actions:{handles:["chipClicked","chipRemoved"]}},render:i=>r`
    <ino-chip
  ...
  `}),t=o({...n,render:()=>{const i=["Chip 1","Chip 2","Chip 3"],l=new Set,c=e=>{if(!(e!=null&&e.value))return;const s=l.has(e.value);e.selected=!s,s?l.delete(e.value):l.add(e.value)};return r`
      <div class="ino-chip-story">
        ${i.map(e=>r` <ino-chip value="${e}" selectable @chipClicked="${s=>c(s.target)}"
            >${e}
          </ino-chip>`)}
      </div>
  ...
  \`
})`,...(I=(F=a.parameters)==null?void 0:F.docs)==null?void 0:I.source},description:{story:"In order to include icons, use the `icon-leading` or `icon-trailing` slot",...(L=(D=a.parameters)==null?void 0:D.docs)==null?void 0:L.description}}};var T,P,R,w,x;t.parameters={...t.parameters,docs:{...(T=t.parameters)==null?void 0:T.docs,source:{originalSource:`Story({
  ...Default,
  render: () => {
...
})`,...(R=(P=t.parameters)==null?void 0:P.docs)==null?void 0:R.source},description:{story:"In order to use ino-chips as filter, use `selectable` on each element",...(x=(w=t.parameters)==null?void 0:w.docs)==null?void 0:x.description}}};var M,E,O,H,N;d.parameters={...d.parameters,docs:{...(M=d.parameters)==null?void 0:M.docs,source:{originalSource:`Story({
  ...Default,
  render: () => {
