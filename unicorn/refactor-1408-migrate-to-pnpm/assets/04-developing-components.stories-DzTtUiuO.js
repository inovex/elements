...
`,e.jsxs(n.li,{children:["The appropriate file structure (see above) will be created for you if you create your new component with the ",e.jsx(n.code,{children:"new-component"})," script (run with ",e.jsx(n.code,{children:"pnpm new:component"}),")"]}),`
