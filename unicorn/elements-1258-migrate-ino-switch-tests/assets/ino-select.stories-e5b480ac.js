import{x as u}from"./lit-html-f27292d4.js";import{S as t}from"./StoryWrapper-9a52780a.js";import{s as U}from"./utils-784729f7.js";import"./elements-stencil-docs-a1cadc86.js";const{useEffect:Y}=__STORYBOOK_MODULE_PREVIEW_API__,S=e=>{e.preventDefault(),U("Form submitted.")},g=e=>e.target.setAttribute("value",e.detail),h=u`
...
`,j={title:"Input/ino-select",component:"ino-select",parameters:{actions:{handles:["valueChange .customizable-select","submit .form"]}},decorators:[e=>(Y(()=>{const n=document.querySelector("form");n==null||n.addEventListener("submit",S);const b=document.querySelectorAll("ino-select");return b.forEach(m=>m.addEventListener("valueChange",g)),()=>{b.forEach(m=>m.removeEventListener("valueChange",g)),n==null||n.removeEventListener("submit",S)}},[]),e())],render:e=>u`
    <ino-select
      disabled="${e.disabled}"
      name="${e.name}"
      outline="${e.outline}"
  ...
  ...InoSelectMeta
})`,...(f=(y=o.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};var O,P,F;r.parameters={...r.parameters,docs:{...(O=r.parameters)==null?void 0:O.docs,source:{originalSource:`Story({
  ...Default,
  docsFromProperty: 'outline',
  args: {
    outline: true
  }
})`,...(F=(P=r.parameters)==null?void 0:P.docs)==null?void 0:F.source}}};var w,$,D;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`Story({
  ...Default,
