import{x as P}from"./lit-html-f27292d4.js";import{S as t}from"./StoryWrapper-9a52780a.js";import"./elements-stencil-docs-a1cadc86.js";const S={title:"Notification/ino-progress-bar",component:"ino-progress-bar",argTypes:{buffer:{control:{min:0,max:1,step:.1}},progress:{control:{min:0,max:1,step:.1}}},render:a=>P`
    <ino-progress-bar
      buffer="${a.buffer}"
      progress="${a.progress}"
