...
let InoImgList = class {
  ...
  render() {
    ...
    return h(Host, null, h("ul", { class: classes }, h("slot", null)));
  }
  get el() {
    return getElement(this);
  }
};
InoImgList.style = inoImgListCss;
export { InoImgList as ino_img_list };
