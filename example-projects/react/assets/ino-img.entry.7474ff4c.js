...
let Image = class {
  ...
  render() {
    ...
    return h(Host, { class: hostClasses }, h("div", { class: divClasses }, h("img", { class: imgClasses, alt: this.alt, decoding: this.decoding, ref: (ref) => this.imageEl = ref, sizes: this.sizes, src: this.src, srcset: this.srcset, usemap: this.usemap, height: !isNaN(this.height) ? this.height : void 0, width: !isNaN(this.width) ? this.width : void 0 }), h("div", { class: "ino-img__fallback-icon" }, h("ino-icon", { icon: this.fallbackIcon }))), this.imgListItem && h("div", { class: "mdc-image-list__supporting" }, h("span", { class: "mdc-image-list__label" }, this.label)));
  }
  get el() {
  ...
  static get watchers() {
    return {
      ...
      "width": ["widthChanged"],
      "ratioWidth": ["ratioWidthChanged"],
      "ratioHeight": ["ratioHeightChanged"]
    };
  }
};
Image.style = inoImgCss;
export { Image as ino_img };
